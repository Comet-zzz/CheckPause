MESSAGES = {
    ...
    "cloud_account_show_password": "Show password",
    "cloud_account_sign_in": "Sign in",
    "cloud_account_register": "Create account",
    "cloud_account_signed_in": "Signed in as {username}",
    "cloud_account_balance": "Balance: {balance} CP credits",
    "cloud_account_balance_unknown": "Balance: could not be read",
    "cloud_account_refresh": "Refresh balance",
    "cloud_account_sign_out": "Sign out",
    "cloud_account_welcome": "Welcome, {username}.",
    "cloud_account_signed_out": "Signed out.",
    "cloud_account_needs_signin": "Cloud mode needs an account. Sign in now?",
    "cloud_account_not_signed_in": "Not signed in",
    "cloud_account_close": "Close",
    "cloud_account_working": "Talking to the server...",
    "cloud_account_username_empty": "Enter a username.",
    ...
    "btn_first": "First move",
    "btn_prev": "Previous move",
    "btn_next": "Next move",
    "btn_last": "Last move",
    "board_step": "Step {index} / {total}",
    "btn_edit_board": "Edit board",
    "edit_hint": "Drag a piece to move it; right-click or press ✕ to delete (dragging it off the board also works). Pick a piece above, then click the board to place it.",
    "edit_erase": "Erase piece",
    "edit_turn_label": "Side to move:",
    "edit_side_white": "White",
    "edit_side_black": "Black",
    "edit_castling_label": "Castling:",
    "edit_castling_hint": "K/Q white kingside/queenside, k/q black kingside/queenside",
    "edit_ep_label": "En passant:",
    "edit_ep_none": "None",
    "btn_edit_start": "Start position",
    "btn_edit_empty": "Clear board",
    "btn_edit_copy_fen": "Copy FEN",
    "btn_edit_apply": "Apply",
    "btn_edit_cancel": "Cancel",
    "edit_fen_copied": "FEN copied.",
    "edit_finish_first": "Apply or cancel the board edit before analyzing.",
    "status_line_changed": "Line updated; analyze again when ready.",
    ...
    "puzzle_hint": "Hint",
    "puzzle_retry": "Retry",
    "puzzle_favorite": "Favorite",
    "puzzle_unfavorite": "Unfavorite",
    "puzzle_favorited": "Added to favorites.",

MESSAGES = {
    ...
    "cloud_no_credit_detail": "Not enough credits: balance {balance}, this request needs about {needed}.",

    "action_cloud_account": "Cloud account...",
    "cloud_account_title": "Cloud account",
    "cloud_account_hint": "Cloud analysis is paid for with credits. Contact the author to top up; your balance is below.",
    ...
    "cloud_account_balance": "Balance: {balance} credits",
    ...
    "cloud_account_menu_signed_in": "Cloud account ({username} · {balance} credits)...",

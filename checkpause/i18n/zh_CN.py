MESSAGES = {
    ...
    "cloud_no_credit_detail": "积分不足：余额 {balance} 积分，本次约需 {needed} 积分。",

    "action_cloud_account": "云端账号...",
    "cloud_account_title": "云端账号",
    "cloud_account_hint": "云端讲解按积分计费。充值请联系作者，余额显示在下面。",
    ...
    "cloud_account_balance": "余额：{balance} 积分",
    ...
    "cloud_account_menu_signed_in": "云端账号（{username} · {balance} 积分）...",

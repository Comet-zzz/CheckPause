...
1. 从文末「下载」获取 `CheckPause-v1.2.1-windows-x64.zip`；  
   Get `CheckPause-v1.2.1-windows-x64.zip` from the Download section at the end of this file.
...
**最新版 / Latest: CheckPause v1.2.1（Windows x64）**

- 📦 [CheckPause-v1.2.1-windows-x64.zip](https://github.com/Comet-zzz/CheckPause/releases/download/v1.2.1/CheckPause-v1.2.1-windows-x64.zip)（123.7 MB，已内置 Stockfish、开局库与棋子资源）
- SHA-256：`5EACBF0D16EA28CE8D7DD3F954F381AF6D3050F3F334146AF346FECEAA6701F9`
